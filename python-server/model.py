...
if __name__ == '__main__':
  ...
  print("choose the prediction type: either 'cancer_vs_normal' or 'highrisk_vs_lowrisk'")
  prediction_type =sys.argv[1]
  print("choose the classifier: 'Random_Forest', 'Logistic_Regression' and 'SVM' are included")
  classifier_name =sys.argv[2]
  # After specify the prediction_type and classifier model, choose the top (5/10) genes from the 
  # correpsondig ranked genes list(get from the result of GSEA)
#     ??????? how to pass a list as command line arguement
  genelist = sys.argv[3]
#   genelist = ['AAAS','ERAS','MPO','BTBD2','MYG1']
  ...
  second_feature_selection(final_genelist,classifier_name,X)
